  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className='linenear'>
          <span className='lg:bg-gray-200 backdrop-blur-2xl bg-gradient-to-b dark:bg-custom-zinc-800 dark:border-neutral-800 dark:from-inherit '>Go Apply</span>
        </div>
